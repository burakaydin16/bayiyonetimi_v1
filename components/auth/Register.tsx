...
import { UserPlus, LogIn, Building2, Mail, Lock } from 'lucide-react';
...
export const Register: React.FC<RegisterProps> = ({ onRegisterSuccess, onSwitchToLogin }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await authService.registerTenant(name, email, password);
            setSuccess(true);
            setTimeout(() => {
                onSwitchToLogin();
            }, 2000);
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4 font-sans">
            <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-500 mt-2 font-medium">SaaS sistemine yeni hesap oluşturun</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 ml-1 uppercase tracking-wider">Admin Kullanıcı Adı</label>
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                className="w-full bg-gray-50 border-2 border-gray-200 rounded-xl py-3.5 pl-12 pr-4 text-gray-900 font-medium placeholder-gray-400 focus:outline-none focus:border-emerald-500 focus:bg-white transition-all"
                                placeholder="Yönetici adını belirleyin"
                                value={email}
                    ...
                    <button
                        ...
                        className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-black py-4 px-4 rounded-xl shadow-lg shadow-emerald-200 transform transition-all active:scale-[0.97] disabled:opacity-50 disabled:cursor-not-allowed mt-4 flex items-center justify-center gap-3 text-lg"
                    >
